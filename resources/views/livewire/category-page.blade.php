        ...
        <div class="container">
            ...
            <div class="row mb-3 mt-4" data-aos="fade-up">
                ...
                <div class="col-12 col-lg-8 stretch-card grid-margin">
                    <div class="position-relative hover-effect">
                        <div class="post-thumb position-relative">
                            <img src="{{$item->image}}" alt="banner" class="img-custom-top ffff w-100 cursor-pointer" />
                        ...
                        <div class="banner-content">
                            ...
                            <div class="fs-12">
                                <span class="mr-2">{{$item->author}} - </span>{{$item->created_at->toFormattedDateString()}}
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-4 grid-margin d-lg-flex">
                    <div class="position-relative hover-effect">
                        <div class="post-thumb position-relative">
                            <img src="{{$item->image}}" alt="banner" class="img-custom-top" />
            ...
            <div class="row" data-aos="fade-up">
                ...
                <div class="col-12 col-md-6 col-xl-3 mb-3">
                    <div class="position-relative hover-effect">
                        <div class="post-thumb position-relative">
                            <img src="{{$item->image}}" alt="banner" class="img-custom" />
                            <div class="img-overlay"></div>
                        </div>
                        <!-- <div class="badge badge-danger p-1 top-right">Global News</div> -->
                        <div class="banner-content">
