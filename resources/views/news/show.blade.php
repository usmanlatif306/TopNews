@extends('layouts.app')
@section('title', $news->title .' - '.config('app.name', 'Laravel'))
@section('content')
            ...
            <div class="col-md-8 mb-4">
                ...
                <section class=" mb-4 pb-4">
                    <div class="d-flex justify-content-between border border-light p-3 rounded mx-2">
                        <!-- pevious news -->
                        @if($news->previous)
                        <a href="{{route('news.show',[$news->previous->category,$news->previous->slug])}}" class="btn btn-outline-secondary">Previous News</a>
                        @else
                        ...
                        <!-- next news -->
                        @if($news->next)
                        <a href="{{route('news.show',[$news->next->category,$news->next->slug])}}" class="btn btn-outline-secondary">Next News</a>
                        @else
